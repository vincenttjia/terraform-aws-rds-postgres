...
| <a name="input_replicate_source_db"></a> [replicate\_source\_db](#input\_replicate\_source\_db) | The source db of read replica instance | `string` | `""` | no |
...
| <a name="input_snapshot_identifier"></a> [snapshot\_identifier](#input\_snapshot\_identifier) | The snapshot ID used to restore the DB instance | `string` | `""` | no |
